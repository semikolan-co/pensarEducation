          ...
          <div class="accordion-body">
            ...
            <div class="accordion" id="accordionSecondExample">
              ...
              <div class="accordion-item">
                ...
                <div id="collapseSecond{{$lesson->id}}" class="accordion-collapse collapse @if($loop->iteration == 1) show @endif " aria-labelledby="headingSecond{{$lesson->id}}" data-bs-parent="#accordionSecondExample">
                  <div class="accordion-body">
                    ...
                    <table class="table table-hover my-0">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <th>{{$quiz->name}}</th>
                              <th>
                                <a href="{{route('geteditquiz',['id'=>$quiz->id])}}"  ><i class="align-middle"  data-feather="edit"></i></a>
                                <span class="delete"   data-id="{{$quiz->id}}" data-name="{{$quiz->name}}" ><i class="align-middle"  data-feather="trash"></i></span>
                              </th>
                          </tr>
                          @empty @endforelse
                      </tbody>
